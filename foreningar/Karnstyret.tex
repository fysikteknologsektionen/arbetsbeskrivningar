...
\renewcommand{\forening}{Kärnstyret} % Används för headern bl.a.
...
\begin{foreningenv}{\forening{}} % Hanterar mycket av logiken kring enskild/gemensam kompilering. Argumentet blir rubriken
    ...
    \begin{description}
        ...
        %\item[att] vid sektionsmöte bära skägg som kliar. nyttnytt
    ...
    \begin{description}
        ...
        \item[att] informera sektionens kassörer när deras budgetar ska vara inlämnade. %nyttnytt
