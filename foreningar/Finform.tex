...
\renewcommand{\forening}{Finform} % Används för headern bl.a.
...
\begin{foreningenv}{\forening{}} % Hanterar mycket av logiken kring enskild/gemensam kompilering. Argumentet blir rubriken
    ...
    Finforms redaktion består av chefredaktör tillika ansvarig utgivare, kassör, minst två redaktörer, %samt sektionsfotograf, nyttnytt
    ...
    % \subsection{Sektionsfotografen} nyttnytt
