...
\begin{foreningenv}{\forening{}} % Hanterar mycket av logiken kring enskild/gemensam kompilering. Argumentet blir rubriken
    ...
    \begin{description}
        ...
        %\item[att] ansvara för att Fysikteknologsektionen prenumererar på tidningen Fantomen samt ordna så att tidningen finns tillgänglig för sektionsmedlemmarna. nyttnytt
